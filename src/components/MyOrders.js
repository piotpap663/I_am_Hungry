...
import { ENDPOINT_GET_USER_ORDERS } from '../config';
                  ...
                  <Paper className={classes.root} elevation={1}>
                    ...
                    {product.products.map(item => (
                      <span>
                        ...
                        <br />
                        {item.extras && item.extras.length
                          ? item.extras.map(extra => <span>{extra.name}</span>)
                          : null}
                      </span>
                    ))}
                    Opinia:
                    <br />
                    <Opinion
                      editing={product.opinion === null}
                      value={
                        (product.opinion && product.opinion.message) ||
                        product.opinion !== null
                          ? product.opinion.message
                          : null
                      }
                      stars={
                        product.opinion && product.opinion.stars
